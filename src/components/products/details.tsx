  ...
  return (
    <div className="pro-detail w-full flex flex-col justify-center order-last lg:order-none max-lg:max-w-[608px] max-lg:mx-auto">
      ...
      <p className="text-gray-500 text-base font-normal mb-8">
        the perfect companion for your next adventure! Embrace the spirit of
        sunny escapades with this vibrant and versatile bag designed to cater to
        your travel needs while adding a pop of color to your journey.
      </p>
        ...
        <div className="text">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
            <div className="flex items-center justify-center w-full">
              ...
              <span className="group py-3 px-6 border border-gray-400  shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-300 hover:bg-gray-50 text-gray-700 group-hover:text-black">
                {quantity}
              </span>
              <button
                onClick={increment}
